...
export class RestApplication {
  ...
  constructor(
    ...
    // @inject(Component.Io) private readonly io: Socket,
    @inject(Component.DatabaseClient) private readonly databaseClient: DatabaseClient,
    @inject(Component.VoterController) private readonly voterController: Controller,
    @inject(Component.UserController) private readonly userController: Controller,
    @inject(Component.FormController) private readonly formController: Controller,
  ...
  private async _initControllers() {
    this.express.use('/voters', this.voterController.router);
    this.express.use('/users', this.userController.router);
    this.express.use('/form', this.formController.router);
  }
  ...
  private async _initMiddleware() {
    ...
    //   secret: this.config.get('DB_PASSWORD'),
    //   resave: true,
